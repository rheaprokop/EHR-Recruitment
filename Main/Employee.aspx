          ...
          <tr><td>
            <table style="width: 90%; margin-top: 20px;" class="zebra" align="center">  
                ...
                <tbody>
                        ...
                        <td>For Location: </td>
                         <td>
                         <asp:DropDownList runat="server" ID="ddlLocation" ReadOnly>
                ...
                <tbody>
                    ...
                    <tr>
                     ...
                     <td class="form-label">Address 2: <span style="color: red; display: inline;">*</span></td>
                         <td align="left">
                        <asp:Label runat="server" ID="lblAddress2"  CssClass="candidate-label"></asp:Label>
                              </td>
                         <td class="form-label">Nationality: <span style="color: red; display: inline;">*</span></td>
                         <td align="left"><asp:Label runat="server" ID="lblNationality"  CssClass="candidate-label"></asp:Label>
                          </td>  
                    </tr>
                     <tr>
                ...
                <tbody>
                     ...
                     <tr>
                        ...
                        <tr>
                         <td >Birth Number: </td>
                         <td>
                        <asp:Textbox runat="server" ID="txtBirthNumber"></asp:Textbox>
                         </td>
                         <td >National Number: </td>
                         <td>
                        <asp:Textbox runat="server" ID="txtUIN_SGP"></asp:Textbox>
                         </td>
