<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" AutoEventWireup="true" CodeBehind="Update.aspx.cs" Inherits="EHR.Main.Update" %>
            ...
            <table style="width: 100%; margin-top: 20px;" class="zebra">
                ...
                <tbody>
                    <tr>
                         ...
                         <td><asp:TextBox ID="txtFirstName" runat="server" MaxLength="25"></asp:TextBox>
                         ...
                         <td><asp:TextBox ID="txtLastName" runat="server" MaxLength="25"></asp:TextBox>
         ...
         <table style="width: 100%; margin-top: 20px;" class="zebra">
                ...
                <tbody>
                     ...
                     <tr>
                         ...
                         <td><asp:Textbox ID="txtStreet" runat="server"  style="size: 20;" MaxLength="70"/>
                         <asp:RequiredFieldValidator  runat="server" ID="RequiredFieldValidator1" ControlToValidate="txtStreet"
                          ErrorMessage="Required!"  cssClass="reqErrorMsg" style="display: inline;"></asp:RequiredFieldValidator>
                         </td>
                     ...
                     <tr>
                         <td class="form-label">Country of Citizenship: <span style="color: red; display: inline;">*</span></td>
                         <td>
                         <asp:DropDownList runat="server" ID="ddlCountry">
                            ...
                            <asp:RequiredFieldValidator  runat="server" ID="RequiredFieldValidator2" ControlToValidate="ddlCountry"
                          ErrorMessage="Required!"  cssClass="reqErrorMsg" style="display: inline;"></asp:RequiredFieldValidator>
                         </td>
                         <td class="form-label">Postcode/zip code: </td>
                         <td><asp:Textbox ID="txtPostCode" runat="server" style="size: 20;" MaxLength="5" /></td>                         
                    </tr>  
                   <tr>
                         <td class="form-label">Contact Number: </td>
                         <td>(+420) <asp:Textbox ID="txtContact" runat="server" Width="200" MaxLength="9"/></td>
                         <td class="form-label">Email Address: </td>
                         <td><asp:Textbox ID="txtEmailAddress" runat="server" style="size: 20;" />
                ...
                <tbody>
                     ...
                     <tr>
                        ...
                        <asp:Textbox ID="txtYear" runat="server"  Width="80" />  
                         ...
                         <td class="form-label">Sex: <span style="color: red; display: inline;">*</span> </td>
                         <td>
                         ...
                         <asp:ListItem Value="F">Female</asp:ListItem>
                          ...
                          <asp:RequiredFieldValidator  runat="server" ID="RequiredFieldValidator3" ControlToValidate="ddlSex"
                          ErrorMessage="Required!"  cssClass="reqErrorMsg" style="display: inline;"></asp:RequiredFieldValidator>
                         </td>                         
                    </tr> 
                      <tr>
                         ...
                         <td class="form-label" colspan="2">  <asp:RequiredFieldValidator  runat="server" ID="reqddlDay" ControlToValidate="ddlDay"
...
<tr><td>
   ...
   <tr>
                       <td>Academic Title: </td>
                         ...
                         <td>
                           <asp:DropDownList runat="server" ID="ddlHighestEducLevel">
                         <asp:ListItem Value="">Select One</asp:ListItem>
                         ...
                         <asp:ListItem Value="G">Bachelor Level Degree</asp:ListItem>
                           ...
                           <asp:RequiredFieldValidator  runat="server" ID="RequiredFieldValidator4" ControlToValidate="ddlHighestEducLevel"
                          ErrorMessage="Required!"  cssClass="reqErrorMsg" style="display: inline;"></asp:RequiredFieldValidator>
                         </td>                         
                    </tr>  
                     <tr>
                         ...
                         <td>
                        <asp:DropDownList runat="server" ID="ddlGraduate">
                                 <asp:ListItem Value="">Select One</asp:ListItem>
                       ...
                       <asp:RequiredFieldValidator  runat="server" ID="RequiredFieldValidator5" ControlToValidate="ddlGraduate"
                          ErrorMessage="Required!"  cssClass="reqErrorMsg" style="display: inline;"></asp:RequiredFieldValidator>
                         </td>
                         <td class="form-label">Field: </td>
                         <td>
                         <asp:Textbox ID="txtField" runat="server" style="size: 30;"   />
                         </td>                         
                    </tr>  
 ...
 <tr>
                                 ...
                                 <asp:ListItem Value="OT">Other</asp:ListItem> 
                                  ...
                                  <asp:RequiredFieldValidator  runat="server" ID="RequiredFieldValidator6" ControlToValidate="ddlLanguage1"
                          ErrorMessage="Required!"  cssClass="reqErrorMsg" style="display: inline;"></asp:RequiredFieldValidator>
                                 </td>
                                 <td class="form-label">Level: <span style="color: red; display: inline;">*</span></td>
                                 <td>
                                 <asp:DropDownList runat="server" ID="ddlSkill1">
...
<asp:RequiredFieldValidator  runat="server" ID="RequiredFieldValidator7" ControlToValidate="ddlSkill1"
                          ErrorMessage="Required!"  cssClass="reqErrorMsg" style="display: inline;"></asp:RequiredFieldValidator>                                 
                                 </td>                         
                            </tr>                   
 <tr>
                                 ...
                                 <td>
                                 <asp:DropDownList runat="server" ID="ddlSkill2">
                                 <asp:ListItem Value="" Selected="True">Select Level</asp:ListItem>
                                 <asp:ListItem Value="Beginner">Beginner</asp:ListItem>
                                 <asp:ListItem Value="Intermediate">Intermediate</asp:ListItem>
                                   <asp:ListItem Value="Advanced">Advanced</asp:ListItem>
...
<table style="width: 100%; margin-top: 20px;" class="zebra">
                ...
                <tbody>
                   <tr>
                         ...
                         <td>
                         <asp:Textbox ID="txtExpertise" runat="server" style="size: 30;"   />
                         </td>                         
                    </tr> 
                     <tr>
                         <td class="form-label">Current Employer: </td>
                         <td>
                        <asp:Textbox ID="txtCurrentEmpl" runat="server" style="size: 30;"   />
                       
                         </td>
                         <td class="form-label">Current Position: </td>
                         <td>
                         <asp:Textbox ID="txtCurrentPosi" runat="server" style="size: 30;"   />
                         </td>                         
                    </tr> 
 </table>
</td></tr>
...
<table style="width: 100%; margin-top: 20px;" class="zebra">
                <thead>
                    ...
                    <tr>
                           ...
                           <td style="width: 200px"><asp:Label runat="server" ID="lblVehicleChk" Text="Which Vehicle:" ></asp:Label> </td>
                           <td >
                           
                                 <asp:CheckBoxList ID="chkVehicle" style="border: 0; width: 1px;"
                ...
                <tbody> 
                     <tr>
                       <td class="form-label">Upload Czech CV: </td>
                         <td>
                         <asp:FileUpload ID="fileCzechCV" runat="server" /><br /><asp:HyperLink runat="server" ID="linkIsCVCZ" CssClass="candidate-label" Target="_blank"></asp:HyperLink>
                       </td>
                         <td class="form-label">Upload English CV: </td>
                         <td >
                         <asp:FileUpload ID="fileEnglishCV" runat="server" /><br /><asp:HyperLink runat="server" ID="linkIsCVEN" CssClass="candidate-label" Target="_blank"></asp:HyperLink>
                         </td>
...
<tr><td>       
 ...
 <tr><td>
   <asp:Button ID="btnUpdate" OnClick="BtnUpdate_Click"  runat="server" text="Update Candidate Record" CssClass="ui-button ui-button-text-only ui-widget ui-state-default ui-corner-all" style="font-family: BebasNeue; font-size: 16px; letter-spacing: 1px; float: right;" />
