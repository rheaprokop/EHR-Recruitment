...
namespace EHR.Recruitment
{
    public partial class ViewRequest : System.Web.UI.UserControl
    {
        ...
        private void IfRequestDone()
        {
            ...
            string GetStats = "Select RESULT from EREC_REQUESTS where REQUESTID='" + id + "'";
            MyObjects.GetConn();
        ...
        private void LoadDeptAssistant()
        {
            string requestID = Request.QueryString["id"];
            string deptid;
            string queryDeptID = "Select REQUESTORDEPTID From EREC_REQUESTS Where REQUESTID = '" + requestID + "'";
        ...
        protected void IsApprove(object sender, EventArgs e)
        {
              ...
              string OracleStatus = "Update EREC_REQUESTS set STATUS = '" + FlowID + "' " +
              ...
              if (Page.IsPostBack == true)
              {
                  ...
                  string OracleQryUpdateReq = "Update EREC_REQUESTS Set HRRECRUITER = :HRrecruiter, " +
        ...
        protected void IsReject(object sender, EventArgs e)
        {
            ...
            MyObjects.GetConn();
            string OracleToEmail = "Select REQUESTOR From EREC_REQUESTS Where REQUESTID='" + RequestID + "'";
        ...
        protected void BtnNeedChanges_Click(object sender, EventArgs e)
        {
            string requestID = Request.QueryString["id"];
            string flowID = Request.QueryString["flow"];
            string RequestUpdateStats = "Update EREC_REQUESTS Set RESULT = 'Update For Changes' " +
                                "Where REQUESTID='" + requestID + "'";
