<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" AutoEventWireup="true" CodeBehind="Reports.aspx.cs" Inherits="EHR.Recruitment.Reports" %>
...
<asp:Label ID="lblCandidateTitle" Text="Viewing Requests" runat="server" CssClass="logotext"></asp:Label>
 ...
 <asp:Panel runat="server" ID="pnlReportsFront">
...
<asp:Label runat="server" ID="lblReqError" style="font-size: 11px;"></asp:Label><br />
    ...
    AllowPaging ="true" OnPageIndexChanging = "OnPaging" runat="server" CssClass="grid-zebra" style="width: 1200px;"  
...
<asp:Panel ID="pnlWelcome" runat="server" CssClass="pnlWelcome" style="margin-top: 20px;">
    <div class="header"> 
...
<tr>
<td colspan="2">
<asp:UpdatePanel ID="pnlgridCandidates" runat="server">
<ContentTemplate> 
...
<asp:Label runat="server" ID="lbl_CanError" style="font-size: 11px;"></asp:Label><br />
     ...
     AllowPaging="false"  runat="server" CssClass="grid-zebra" style="width: 1100px;"   OnPageIndexChanging = "OnPagingCandidate"    
     PagerSettings-FirstPageText="First" PagerSettings-LastPageText="Last" PagerSettings-FirstPageImageUrl="first.png">
       <Columns>  
